...
export const SCROLL_CONSTANTS = {
  // Distance thresholds
  DISTANCE_FROM_BOTTOM_TOLERANCE: 150, // px - tolerance for "at bottom" detection (more tolerant)
  NEAR_BOTTOM_THRESHOLD: 600, // px - threshold for "near bottom" during streaming (handles rapid growth)
  AT_BOTTOM_THRESHOLD: 80, // px - strict "at bottom" threshold
  VERY_FAR_FROM_BOTTOM: 400, // px - threshold for very far from bottom
  ...
  VERY_SIGNIFICANT_SCROLL_UP: 120, // px - stricter threshold during streaming
  ...
  SCROLL_FOLLOW_UP_DELAY: 16, // ms - one frame for follow-up scroll checks
  EXTRA_PERSISTENCE_DELAYS: [16, 33, 66, 100, 150, 250, 400, 600], // ms - multiple delays for streaming persistence

  // Initial render delays
  INITIAL_SCROLL_DELAY: 80, // ms - slight nudge for initial scroll to bottom
  MOBILE_RENDER_DELAY: 200, // ms - additional delay for mobile iOS rendering
  FETCH_SCROLL_POSITION_DELAY: 120, // ms - delay after fetching to restore scroll position
...
export const A11Y_CONSTANTS = {
  ...
  SCROLL_TO_BOTTOM_DESCRIPTION:
    "Scrolls the conversation view to the most recent message",
} as const
