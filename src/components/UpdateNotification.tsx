...
const UpdateNotification = () => {
  const [updateState, setUpdateState] = useState<UpdateServiceState>(getUpdateState());
  ...
  useEffect(() => {
    ...
    const handleUpdateError = (event: CustomEvent<{outdated: boolean, message: string}>) => {
    ...
    return () => {
      window.removeEventListener(UPDATE_READY, handleUpdateReady as EventListener);
      window.removeEventListener(UPDATE_ERROR, handleUpdateError as EventListener);
    };
  }, []);
