...
export function useIntentRecognition() {
    ...
    if (context === undefined) {
        throw new Error('useIntentRecognition must be used within an IntentRecognitionProvider');
    }
    return context;
}
...
export function IntentRecognitionProvider({ children }) {
    ...
    return (
        <IntentRecognitionContext.Provider value={{ isLoaded, models: intentRecognition }}>
            {children}
